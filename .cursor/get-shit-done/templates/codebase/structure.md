...
- Usage: Reference from command with `@/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
