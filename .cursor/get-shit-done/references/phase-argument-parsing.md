...
```bash
PHASE_INFO=$(node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
