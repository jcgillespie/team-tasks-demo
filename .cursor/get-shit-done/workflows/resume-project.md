...
<required_reading>
@/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" init resume)
