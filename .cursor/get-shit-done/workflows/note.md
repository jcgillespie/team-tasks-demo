...
- **Global scope**: `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/notes/`)
...
2. Glob `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/notes/` — works in any directory
