...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done
                  → writes to /Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
