...
Use template from `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/joshgillespie/src/team-tasks-demo/gsd/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
